window.view = {
	...
	validateRightangletriangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a Rightangletriangle requires the base and height of Rightangletriangle. Try again.')
		else if ( b !== 'float' )
	...
	displayFunctionForRightangletriangle: function() {
		document.getElementById('functionRightangletriangle').innerHTML += 'float area_Rightangletriangle (float a,float b)<br>{<br> &emsp; float area = a*b/2;<br> &emsp; return area;<br>}'
	},
